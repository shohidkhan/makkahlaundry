        ...
        <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                ...
                <ul class="breadcrumb fw-semibold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted"> Become Tutor </li>
                    <li class="breadcrumb-item text-muted"> How to work</li>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">How lesson work</h3>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.cms.home-how-work.update') }}"
                                ...
                                <div class="mt-4">
                                    ...
                                    <input name="sub_title" id="sub_title" id="description"
                                        ...
                                        placeholder="Enter title" value="{{ old('sub_title', $data->sub_title ?? '') }}">
                                    @error('sub_title')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                ...
                <div class="col-lg-8">
                    <div class="bg-white p-5">
                        <div class="d-flex justify-content-start mb-5">
                            <a href="{{ route('admin.cms.home-how-work.create') }}" class="btn btn-primary">Add
                                works</a>
                        </div>
    ...
    @push('script')
        <script type="text/javascript">
            $(function() {
                ...
                if (!$.fn.DataTable.isDataTable('#data-table')) {
                    let dTable = $('#data-table').DataTable({
                        ...
                        ajax: {
                            url: "{{ route('admin.cms.home-how-work.index') }}",
                            type: "get",
                        },
            ...
            function deleteItem(id) {
                let url = '{{ route('admin.cms.home-how-work.destroy', ':id') }}';
