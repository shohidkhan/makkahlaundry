    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li class="{{ request()->routeIs(['admin.whatsapp.index']) ? 'mm-active' : '' }}">
                    <a href="{{ route('admin.whatsapp.index') }}" class="waves-effect">
                        ...
                        <span key="t-file-manager">Whatsapp</span>
                    </a>
                </li>
                ...
                <li
                    class="{{ request()->routeIs(['admin.cms.banner.*', 'admin.cms.home-how-work.*', 'admin.testimonial.*', 'admin.cms.pricing.index', 'admin.cms.account.index']) ? 'mm-active sidebarParentActive' : '' }}">
                    <a href="javascript: void(0);" class="has-arrow waves-effect" style="color: #000">
                        ...
                        <span key="t-invoices">CMS</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li>
                            <a href="{{ route('admin.cms.banner.index') }}"
                                class="{{ request()->routeIs(['admin.cms.banner.index']) ? 'active' : '' }}"
                                key="t-invoice-list">Banner</a>
                        </li>
